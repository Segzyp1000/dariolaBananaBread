...
const Showcase = () => {
  return (
    <div className="flex flex-col-reverse gap-6 md:flex-row justify-between items-center mx-12 mt-36">
      <div>
        ...
        <a
          href="#menu"
          className="p-1 rounded-lg bg-navColor text-white  hover:text-black"
        >
          Get Started
        </a>
      </div>
